...
## Purpose
Define the requirements for the automated CI/CD pipeline that tests, builds, and deploys the Medi-Nudge system to AWS. Uses GitHub Actions with OIDC-based authentication — no long-lived AWS credentials stored as secrets.
