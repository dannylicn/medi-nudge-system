# Capability: whatsapp-channel

Manages all WhatsApp communication: outbound message dispatch, delivery tracking, inbound webhook validation, and response classification.
