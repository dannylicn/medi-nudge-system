# Capability: nudge-campaigns

Manages the lifecycle of a medication reminder campaign for a patient-medication pair, including message generation (LLM or template fallback), delivery, and response handling.
