# Capability: prescription-ocr

Manages ingestion of prescription/medicine label images, extraction of structured medication data via VLM (GPT-4o Vision primary, Tesseract fallback), and a human review workflow before medication records are auto-populated.
