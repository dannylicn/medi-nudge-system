...
Manages the lifecycle of escalation cases that are raised when patients are unresponsive, report side effects, ask clinical questions, or exceed adherence thresholds. Surfaces these cases to care coordinators for action.
