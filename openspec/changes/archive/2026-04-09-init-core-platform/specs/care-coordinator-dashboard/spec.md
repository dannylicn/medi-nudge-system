# Capability: care-coordinator-dashboard

A React-based web dashboard for care coordinators to monitor patient adherence, manage escalation cases, review OCR scans, enrol patients, and view analytics.
