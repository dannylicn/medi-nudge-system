# Capability: patient-onboarding

Manages the end-to-end process of enrolling a new patient: sending a WhatsApp invite, capturing consent, confirming language, collecting the medication list, setting reminder preferences, and recovering from drop-offs.
